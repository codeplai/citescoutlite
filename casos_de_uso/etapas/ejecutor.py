...
async def etapa(d: Dependencias, ejecucion: Ejecucion, num_etapa: int, func: Callable[..., Awaitable[T]], entrada: Any, **kwargs) -> T:
    ...
    d.auditoria.registrar_etapa(ejecucion, num_etapa, entrada_dict, salida_dict, duracion_ms, costo_usd=0.0, tokens=tokens_usados, tokens_entrada=tokens_entrada, tokens_salida=tokens_salida)
    return resultado
